...
function Card({ label, value, accent }: { label: string; value: string; accent?: 'danger' | 'safe' }) {
  return (
...
export default function SummaryCards({
  ...
  return (
    <div className="flex flex-wrap gap-4">
      <Card label="Rings found" value={String(nRings)} accent="danger" />
      <Card label="Accounts flagged" value={String(nAccountsFlagged)} accent="danger" />
      <Card label="₹ at risk" value={formatRupees(totalRupeeAtRisk)} accent="danger" />
      <Card
